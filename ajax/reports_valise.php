...
if (isset($_POST['fechaInicio']) && $_POST['fechaInicio'] != "" && $_POST['fechaInicio'] != NULL &&
        isset($_POST['fechaInicio']) && $_POST['fechaInicio'] != "" && $_POST['fechaInicio'] != NULL) {
    ...
    try {
        ...
        include("../ajax/info_reports_valise.php");
    ...
    javaalert('Debe Ingresar las Fechas');
    iraURL('../pages/reports_valise.php');
}
?>